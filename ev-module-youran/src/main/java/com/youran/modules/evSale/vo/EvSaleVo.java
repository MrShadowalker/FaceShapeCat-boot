package com.youran.modules.evSale.vo;
...
@ApiModel(value="ev_sale_vo对象", description="销售单商品")
public class EvSaleVo implements Serializable {
    ...
    private List<EvSaleGoods> evSaleGoodsList;
}
