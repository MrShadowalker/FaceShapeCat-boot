  ...
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        ...
        <a-col :span="24">
          <a-form-item label="采购店铺/仓库" v-bind="validateInfos.shopId">
            <a-input v-model:value="formData.shopId" placeholder="请输入采购店铺/仓库" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="负责人" v-bind="validateInfos.buyUserId">
            <a-input v-model:value="formData.buyUserId" placeholder="请输入负责人" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="实际金额" v-bind="validateInfos.payMoney">
	          <a-input-number v-model:value="formData.payMoney" placeholder="请输入实际金额" style="width: 100%" :disabled="disabled"/>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="付款方式" v-bind="validateInfos.payType">
            <a-input v-model:value="formData.payType" placeholder="请输入付款方式" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="到货状态" v-bind="validateInfos.goodsStatus">
            <a-input v-model:value="formData.goodsStatus" placeholder="请输入到货状态" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="支付状态" v-bind="validateInfos.payStatus">
            <a-input v-model:value="formData.payStatus" placeholder="请输入支付状态" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
      </a-row>
    </a-form>
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../EvBuy.api';
