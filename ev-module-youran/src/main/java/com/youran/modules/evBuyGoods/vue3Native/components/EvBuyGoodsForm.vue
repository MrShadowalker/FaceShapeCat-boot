  ...
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        ...
        <a-col :span="24">
          <a-form-item label="采购单ID" v-bind="validateInfos.buyId">
            <a-input v-model:value="formData.buyId" placeholder="请输入采购单ID" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="商品ID" v-bind="validateInfos.goodsId">
            <a-input v-model:value="formData.goodsId" placeholder="请输入商品ID" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../EvBuyGoods.api';
